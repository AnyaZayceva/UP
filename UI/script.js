...
var articleModel = (function () {
  ...
  //  if(localStorage.getItem('content') != null){
   ...
   // }
    var tags = ['политика', 'финансы', 'спорт', 'наука', 'погода', 'происшествия', 'статистика', 'культура', 'мировые новости'];
...
var filter = (function () {
    ...
    var tag_option = document.getElementsByClassName('option');
    var submitButton;
    ...
    function getFilter() {
        ...
        var authorSelect = input;
        var tagSelect = tag_option;
        var beginDateSelect = begin_date;
        var endDateSelect = end_date;
       ...
       // } else {
            return {
                ...
                beginDate: beginDateSelect.value,
                endDate: endDateSelect.value
            }
        //}
    }
...
var addNewsForm = (function () {
    ...
    function handleSubmit() {
       article.id = articleModel.articles.length + 2;
       ...
       articleModel.addArticle(article);
        ...
        tag.value = '';
        text.value = '';
       //articleRenderer.insertArticlesInDOM(articleModel.articles);
        showArticles();
    }
...
/*function getUser(user) {
    var USER = document.getElementById('user-name');
    var BUTTON = document.getElementById('sign-in');
    var but = document.querySelector('.news');
    ...
    if (user === undefined) {
        ...
        USER.firstElementChild.textContent = user;
